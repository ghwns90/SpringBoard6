...
<body>
  <main>	
	...
	<form action = "/BoardPaging/Update" method="POST">
		...
		<!--  게시물 목록 -->
		<a href="/BoardPaging/List?menu_id=${board.menu_id }&nowpage=${nowpage}">목록으로</a>
		<table id = "table">		  	  
		  <tr>
		  	<td>글번호</td>
		    <td>${ board.idx      }</td>
		  ...
		  <tr>
		  	<td colspan="4">
		  		...
		  		<a class="btn btn-dark btn-sm" href="/BoardPaging/List?menu_id=${board.menu_id }&nowpage=${nowpage}">목록</a>&nbsp;&nbsp;
